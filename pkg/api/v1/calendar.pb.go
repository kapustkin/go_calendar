...
It has these top-level messages:
	...
	EditResponse
	RemoveResponse
	GetEventsForSendRequest
	GetEventsForSendResponse
	SetEventAsSentRequest
	SetEventAsSentResponse
*/
package calendarpb
...
type Event struct {
	...
	CreateDate *google_protobuf.Timestamp `protobuf:"bytes,4,opt,name=createDate" json:"createDate,omitempty"`
	EventDate  *google_protobuf.Timestamp `protobuf:"bytes,5,opt,name=eventDate" json:"eventDate,omitempty"`
	Message    string                     `protobuf:"bytes,6,opt,name=message" json:"message,omitempty"`
	IsSended   bool                       `protobuf:"varint,7,opt,name=isSended" json:"isSended,omitempty"`
}
...
type GetEventsForSendRequest struct {
}

func (m *GetEventsForSendRequest) Reset()                    { *m = GetEventsForSendRequest{} }
func (m *GetEventsForSendRequest) String() string            { return proto.CompactTextString(m) }
func (*GetEventsForSendRequest) ProtoMessage()               {}
func (*GetEventsForSendRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{11} }

type GetEventsForSendResponse struct {
	Events []*Event `protobuf:"bytes,1,rep,name=events" json:"events,omitempty"`
}

func (m *GetEventsForSendResponse) Reset()                    { *m = GetEventsForSendResponse{} }
func (m *GetEventsForSendResponse) String() string            { return proto.CompactTextString(m) }
func (*GetEventsForSendResponse) ProtoMessage()               {}
func (*GetEventsForSendResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{12} }

func (m *GetEventsForSendResponse) GetEvents() []*Event {
	if m != nil {
		return m.Events
	}
	return nil
...
type SetEventAsSentRequest struct {
	UserId int32  `protobuf:"varint,1,opt,name=userId" json:"userId,omitempty"`
	Uuid   string `protobuf:"bytes,2,opt,name=uuid" json:"uuid,omitempty"`
}

func (m *SetEventAsSentRequest) Reset()                    { *m = SetEventAsSentRequest{} }
func (m *SetEventAsSentRequest) String() string            { return proto.CompactTextString(m) }
func (*SetEventAsSentRequest) ProtoMessage()               {}
func (*SetEventAsSentRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{13} }

func (m *SetEventAsSentRequest) GetUserId() int32 {
	if m != nil {
		return m.UserId
	}
	return 0
...
func (m *SetEventAsSentRequest) GetUuid() string {
	if m != nil {
		return m.Uuid
	}
	return ""
...
type SetEventAsSentResponse struct {
	Success bool `protobuf:"varint,1,opt,name=success" json:"success,omitempty"`
}

func (m *SetEventAsSentResponse) Reset()                    { *m = SetEventAsSentResponse{} }
func (m *SetEventAsSentResponse) String() string            { return proto.CompactTextString(m) }
func (*SetEventAsSentResponse) ProtoMessage()               {}
func (*SetEventAsSentResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{14} }

func (m *SetEventAsSentResponse) GetSuccess() bool {
	if m != nil {
		return m.Success
	}
	return false
...
func init() {
	...
	proto.RegisterType((*GetEventsForSendRequest)(nil), "calendar.GetEventsForSendRequest")
	proto.RegisterType((*GetEventsForSendResponse)(nil), "calendar.GetEventsForSendResponse")
	proto.RegisterType((*SetEventAsSentRequest)(nil), "calendar.SetEventAsSentRequest")
	proto.RegisterType((*SetEventAsSentResponse)(nil), "calendar.SetEventAsSentResponse")
}
...
type CalendarEventsClient interface {
	...
	GetEventsForSend(ctx context.Context, in *GetEventsForSendRequest, opts ...grpc.CallOption) (*GetEventsForSendResponse, error)
	SetEventAsSent(ctx context.Context, in *SetEventAsSentRequest, opts ...grpc.CallOption) (*SetEventAsSentResponse, error)
}
...
func (c *calendarEventsClient) GetEventsForSend(ctx context.Context, in *GetEventsForSendRequest, opts ...grpc.CallOption) (*GetEventsForSendResponse, error) {
	out := new(GetEventsForSendResponse)
...
func (c *calendarEventsClient) SetEventAsSent(ctx context.Context, in *SetEventAsSentRequest, opts ...grpc.CallOption) (*SetEventAsSentResponse, error) {
	out := new(SetEventAsSentResponse)
	err := grpc.Invoke(ctx, "/calendar.CalendarEvents/SetEventAsSent", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CalendarEventsServer interface {
	...
	GetEventsForSend(context.Context, *GetEventsForSendRequest) (*GetEventsForSendResponse, error)
	SetEventAsSent(context.Context, *SetEventAsSentRequest) (*SetEventAsSentResponse, error)
}
...
func _CalendarEvents_GetEventsForSend_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetEventsForSendRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalendarEventsServer).GetEventsForSend(ctx, req.(*GetEventsForSendRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _CalendarEvents_SetEventAsSent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetEventAsSentRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CalendarEventsServer).SetEventAsSent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/calendar.CalendarEvents/SetEventAsSent",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalendarEventsServer).SetEventAsSent(ctx, req.(*SetEventAsSentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _CalendarEvents_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetEventAsSent",
			Handler:    _CalendarEvents_SetEventAsSent_Handler,
		},
	},
...
var fileDescriptor0 = []byte{
	...
	,
}
